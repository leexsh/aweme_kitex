...
func (p *PublishActionRequest) GetUserId() (v string) {
	return p.UserId
}
...
func (p *PublishActionRequest) SetUserId(val string) {
	p.UserId = val
}
...
var PublishActionResponse_BaseResp_DEFAULT *base.BaseResp

func (p *PublishActionResponse) GetBaseResp() (v *base.BaseResp) {
	if !p.IsSetBaseResp() {
		return PublishActionResponse_BaseResp_DEFAULT
	}
	return p.BaseResp
}
func (p *PublishActionResponse) SetBaseResp(val *base.BaseResp) {
	p.BaseResp = val
}
...
func (p *PublishActionResponse) Field1DeepEqual(src *base.BaseResp) bool {
...
func (p *PublishListResponse) Field2DeepEqual(src []*feed.Video) bool {
