...
func SendUserResponse(c *gin.Context, err error, userId string, token string) {
	Err := errno.ConvertErr(err)
...
// SendRelationActionResponse pack relation list response
...
// PublishListResponse pack favorite list response
